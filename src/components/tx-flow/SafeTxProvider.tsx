...
export type SafeTxContextParams = {
  ...
  setSafeSolTxInstructions?: Dispatch<SetStateAction<TransactionInstruction[] | undefined>>
...
const SafeTxProvider = ({ children }: { children: ReactNode }): ReactElement => {
  ...
  const [safeSolTxInstructions, setSafeSolTxInstructions] = useState<TransactionInstruction[]>()
